...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/src/robotica/install/ej2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ej2/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ej2/environment/path.sh"
