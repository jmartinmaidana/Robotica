...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/src/robotica/install/ej1"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ej1/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ej1/environment/path.sh"
