...
{
  new (message_memory) robmovil_msgs::msg::Landmark(_init);
}

void Landmark_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robmovil_msgs::msg::Landmark *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Landmark_message_member_array[2] = {
  {
    ...
    offsetof(robmovil_msgs::msg::Landmark, range),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robmovil_msgs::msg::Landmark, bearing),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Landmark_message_members = {
  ...
  2,  // number of fields
  sizeof(robmovil_msgs::msg::Landmark),
...
{
  return &::robmovil_msgs::msg::rosidl_typesupport_introspection_cpp::Landmark_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robmovil_msgs, msg, Landmark)() {
  return &::robmovil_msgs::msg::rosidl_typesupport_introspection_cpp::Landmark_message_type_support_handle;
}
