...
{
  new (message_memory) robmovil_msgs::msg::Trajectory(_init);
}

void Trajectory_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robmovil_msgs::msg::Trajectory *>(message_memory);
  typed_message->~Trajectory();
}

size_t size_function__Trajectory__points(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<robmovil_msgs::msg::TrajectoryPoint> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<robmovil_msgs::msg::TrajectoryPoint> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<robmovil_msgs::msg::TrajectoryPoint> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const robmovil_msgs::msg::TrajectoryPoint *>(
    get_const_function__Trajectory__points(untyped_member, index));
  auto & value = *reinterpret_cast<robmovil_msgs::msg::TrajectoryPoint *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<robmovil_msgs::msg::TrajectoryPoint *>(
    get_function__Trajectory__points(untyped_member, index));
  const auto & value = *reinterpret_cast<const robmovil_msgs::msg::TrajectoryPoint *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Trajectory_message_member_array[2] = {
  {
    ...
    offsetof(robmovil_msgs::msg::Trajectory, header),  // bytes offset in struct
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<robmovil_msgs::msg::TrajectoryPoint>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(robmovil_msgs::msg::Trajectory, points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Trajectory_message_members = {
  ...
  2,  // number of fields
  sizeof(robmovil_msgs::msg::Trajectory),
...
get_message_type_support_handle<robmovil_msgs::msg::Trajectory>()
{
  return &::robmovil_msgs::msg::rosidl_typesupport_introspection_cpp::Trajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robmovil_msgs, msg, Trajectory)() {
  return &::robmovil_msgs::msg::rosidl_typesupport_introspection_cpp::Trajectory_message_type_support_handle;
}
