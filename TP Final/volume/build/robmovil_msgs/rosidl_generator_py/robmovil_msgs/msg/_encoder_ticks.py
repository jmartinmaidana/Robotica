...
class EncoderTicks(metaclass=Metaclass_EncoderTicks):
    ...
    _fields_and_field_types = {
        ...
        'ticks_left': 'std_msgs/Int32',
        'ticks_right': 'std_msgs/Int32',
    }
    ...
    def __init__(self, **kwargs):
        ...
        from std_msgs.msg import Int32
        self.ticks_left = kwargs.get('ticks_left', Int32())
        from std_msgs.msg import Int32
        self.ticks_right = kwargs.get('ticks_right', Int32())
    ...
    def ticks_left(self, value):
        if __debug__:
            ...
            assert \
                ...
                "The 'ticks_left' field must be a sub message of type 'Int32'"
    ...
    def ticks_right(self, value):
        if __debug__:
            ...
            assert \
                isinstance(value, Int32), \
                "The 'ticks_right' field must be a sub message of type 'Int32'"
