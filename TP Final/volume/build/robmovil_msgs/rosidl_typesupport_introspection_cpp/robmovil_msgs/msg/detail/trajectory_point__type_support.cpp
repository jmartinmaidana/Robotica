...
{
  new (message_memory) robmovil_msgs::msg::TrajectoryPoint(_init);
}

void TrajectoryPoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<robmovil_msgs::msg::TrajectoryPoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrajectoryPoint_message_member_array[4] = {
  {
    ...
    offsetof(robmovil_msgs::msg::TrajectoryPoint, transform),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robmovil_msgs::msg::TrajectoryPoint, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robmovil_msgs::msg::TrajectoryPoint, acceleration),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(robmovil_msgs::msg::TrajectoryPoint, time_from_start),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrajectoryPoint_message_members = {
  ...
  4,  // number of fields
  sizeof(robmovil_msgs::msg::TrajectoryPoint),
...
{
  return &::robmovil_msgs::msg::rosidl_typesupport_introspection_cpp::TrajectoryPoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robmovil_msgs, msg, TrajectoryPoint)() {
  return &::robmovil_msgs::msg::rosidl_typesupport_introspection_cpp::TrajectoryPoint_message_type_support_handle;
}
