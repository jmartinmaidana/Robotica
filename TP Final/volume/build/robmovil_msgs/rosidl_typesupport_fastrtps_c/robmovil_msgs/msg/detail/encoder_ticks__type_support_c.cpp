...
#include "robmovil_msgs/msg/detail/encoder_ticks__rosidl_typesupport_fastrtps_c.h"
...
#include "std_msgs/msg/detail/int32__functions.h"  // ticks_left, ticks_right
...
using _EncoderTicks__ros_msg_type = robmovil_msgs__msg__EncoderTicks;
...
static uint32_t _EncoderTicks__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robmovil_msgs__msg__EncoderTicks(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robmovil_msgs__msg__EncoderTicks;
    is_plain =
      (
...
static size_t _EncoderTicks__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robmovil_msgs__msg__EncoderTicks(
