...
#include "robmovil_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_c.h"
...
using _TrajectoryPoint__ros_msg_type = robmovil_msgs__msg__TrajectoryPoint;
...
static uint32_t _TrajectoryPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robmovil_msgs__msg__TrajectoryPoint(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robmovil_msgs__msg__TrajectoryPoint;
    is_plain =
      (
...
static size_t _TrajectoryPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robmovil_msgs__msg__TrajectoryPoint(
