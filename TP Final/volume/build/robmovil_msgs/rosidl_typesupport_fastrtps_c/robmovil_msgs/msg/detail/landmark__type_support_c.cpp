...
#include "robmovil_msgs/msg/detail/landmark__rosidl_typesupport_fastrtps_c.h"
...
using _Landmark__ros_msg_type = robmovil_msgs__msg__Landmark;
...
static uint32_t _Landmark__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robmovil_msgs__msg__Landmark(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robmovil_msgs__msg__Landmark;
    is_plain =
      (
...
static size_t _Landmark__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robmovil_msgs__msg__Landmark(
