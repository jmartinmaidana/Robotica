...
#include "robmovil_msgs/msg/detail/landmark_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const robmovil_msgs::msg::Landmark &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const robmovil_msgs::msg::LandmarkArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robmovil_msgs::msg::LandmarkArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: landmarks
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        robmovil_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Landmark(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = robmovil_msgs::msg::LandmarkArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robmovil_msgs::msg::LandmarkArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robmovil_msgs::msg::LandmarkArray *>(
    untyped_ros_message);
...
{
  return &robmovil_msgs::msg::typesupport_fastrtps_cpp::_LandmarkArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robmovil_msgs, msg, LandmarkArray)() {
  return &robmovil_msgs::msg::typesupport_fastrtps_cpp::_LandmarkArray__handle;
}
