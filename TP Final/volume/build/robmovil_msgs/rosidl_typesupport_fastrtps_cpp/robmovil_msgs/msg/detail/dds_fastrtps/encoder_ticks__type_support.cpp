...
#include "robmovil_msgs/msg/detail/encoder_ticks__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const robmovil_msgs::msg::EncoderTicks & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: ticks_left
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.ticks_left,
    cdr);
  // Member: ticks_right
  std_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.ticks_right,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robmovil_msgs::msg::EncoderTicks & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    std_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
    ros_message.ticks_left, current_alignment);
  // Member: ticks_right

  current_alignment +=
    std_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
    ros_message.ticks_right, current_alignment);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robmovil_msgs::msg::EncoderTicks;
    is_plain =
      (
      offsetof(DataType, ticks_right) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const robmovil_msgs::msg::EncoderTicks *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robmovil_msgs::msg::EncoderTicks *>(
    untyped_ros_message);
...
{
  return &robmovil_msgs::msg::typesupport_fastrtps_cpp::_EncoderTicks__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robmovil_msgs, msg, EncoderTicks)() {
  return &robmovil_msgs::msg::typesupport_fastrtps_cpp::_EncoderTicks__handle;
}
