...
void PioneerOdometry::on_encoder_ticks(const robmovil_msgs::msg::MultiEncoderTicks::SharedPtr encoder)
{
  ...
  // d_rueda calcula la distancia que recorre dicha rueda basado en la cantidad de vueltas que dio la rueda la cual 
  ...
  // Transformación al marco global del mapa (Odometdía)
...
//END VISUALIZACIÓN EN CONSOLA
  ...
  last_ticks_rear_right_  = encoder->ticks_right.data;
